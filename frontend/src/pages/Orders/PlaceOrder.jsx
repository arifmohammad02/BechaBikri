  ...
  return (
    <div className="bg-white border border-gray-100 rounded-[2.5rem] p-8 shadow-sm">
      <div className="flex items-center gap-3 mb-6">
        <div className="bg-blue-600 p-2 rounded-xl text-white"><HiOutlineShoppingBag size={24} /></div>
      ...
      <div className="space-y-4 border-t border-b border-gray-50 py-6 mb-6">
        ...
        <div className="flex justify-between items-center text-sm font-mono text-gray-500 font-bold uppercase">
          ...
          <span className={`${shippingCharge === 0 ? "text-green-600" : "text-blue-600"} font-black`}>
      ...
      <div className="flex justify-between items-center mb-8">
        <span className="text-lg font-mono font-black text-gray-900 uppercase tracking-tighter">Total Payable</span>
        <span className="text-2xl font-mono font-black text-blue-600">৳{totalPrice}</span>
      </div>
      ...
      <motion.button
        ...
        className={`w-full py-5 rounded-2xl font-mono font-black text-lg uppercase tracking-widest transition-all flex items-center justify-center gap-3 ${
          isLoading ? "bg-gray-100 text-gray-400 cursor-not-allowed" : "bg-blue-600 text-white hover:bg-black shadow-lg shadow-blue-100"
        }`}
      >
